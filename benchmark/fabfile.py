...
def das(ctx, debug=True, console=False, build=True, username="mputnik"):
    for attack_type, arbitragers, faults, tx_redundancy, lo_size, gamma, workers_per_node, nodes, runs, input_rate in [
        ...
        # (0, 1, 1, None, None, 0.9, 2, 6, 6, 4000),
        # (0, 1, 1, None, None, 0.8, 2, 7, 6, 4000),
        # (0, 1, 1, None, None, 0.7, 2, 10, 6, 4000),
        # (0, 1, 1, None, None, 1.0, 2, 5, 1, 4000),
        # (0, 1, 1, None, 25, 1.0, 2, 5, 6, 2000),
        # (0, 1, 1, None, 50, 1.0, 2, 5, 6, 2000),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 2000),
        # (0, 1, 1, None, 200, 1.0, 2, 5, 6, 2000),
        # (0, 1, 1, None, 400, 1.0, 2, 5, 6, 2000),
        # (0, 1, 1, None, 800, 1.0, 2, 5, 6, 2000),
        # (0, 1, 1, None, None, 1.0, 2, 5, 6, 2000),
        # (0, 1, 1, None, 25, 1.0, 2, 5, 6, 4000),
        # (0, 1, 1, None, 50, 1.0, 2, 5, 6, 4000),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 4000),
        # (0, 1, 1, None, 200, 1.0, 2, 5, 6, 4000),
        # (0, 1, 1, None, 400, 1.0, 2, 5, 6, 4000),
        # (0, 1, 1, None, 800, 1.0, 2, 5, 6, 4000),
        # (0, 1, 1, None, None, 1.0, 2, 5, 6, 4000),
        # ###### N = 5 - CHANGING TPS ######
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 500),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 1000),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 1500),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 2000),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 2500),
        # (0, 1, 3, None, None, 1.0, 2, 13, 5, 3000),
        (0, 1, 3, None, None, 1.0, 2, 13, 1, 3500),
        # (0, 1, 3, None, None, 1.0, 2, 13, 5, 4000),
        # (0, 1, 3, None, None, 1.0, 2, 13, 5, 4500),
        # (0, 1, 3, None, None, 1.0, 2, 13, 5, 5000),
        # (0, 1, 3, None, None, 1.0, 2, 13, 5, 5500),
        # (0, 1, 3, None, None, 1.0, 2, 13, 5, 6000),
        # (0, 1, 3, None, None, 1.0, 2, 13, 5, 6500),
        # (0, 1, 3, None, None, 1.0, 2, 13, 5, 7000),
        # ###### N = 9 ######
        # (1, 3, 0, None, 100, 1.0, 2, 9, 1, 5000),
        # (2, 3, 0, None, 100, 1.0, 2, 9, 1, 5000),
        # (3, 3, 0, None, 100, 1.0, 2, 9, 1, 5000),
        # (10, 3, 0, None, 100, 1.0, 2, 9, 1, 5000),
        # ###### N = 14 ######
        # (1, 3, 0, None, 100, 1.0, 2, 13, 1, 5000),
        # (2, 3, 0, None, 100, 1.0, 2, 13, 1, 5000),
        # (3, 3, 0, None, 100, 1.0, 2, 13, 1, 5000),
        # (10, 3, 0, None, 100, 1.0, 2, 13, 1, 5000),
        # ###### CHANGING N ######
        # (0, 1, 1, None, None, 1.0, 2, 5, 6, 4000),
        # (0, 1, 1, None, None, 1.0, 2, 6, 6, 4000),
        # (0, 1, 1, None, None, 1.0, 2, 7, 6, 4000),
        # (0, 1, 1, None, None, 1.0, 2, 8, 6, 4000),
        # (0, 1, 2, None, None, 1.0, 2, 9, 6, 4000),
        # (0, 1, 2, None, None, 1.0, 2, 10, 6, 4000),
        # (0, 1, 2, None, None, 1.0, 2, 11, 6, 4000),
        # (0, 1, 2, None, None, 1.0, 2, 12, 6, 4000),
        # (0, 1, 3, None, None, 1.0, 2, 13, 6, 4000),
        # (0, 1, 3, None, None, 1.0, 2, 14, 6, 4000),
        # (0, 1, 3, None, None, 1.0, 2, 15, 6, 4000),
        # (0, 1, 3, None, None, 1.0, 2, 16, 6, 4000),
        # (0, 1, 4, None, None, 1.0, 2, 17, 6, 4000),
        # (0, 1, 4, None, None, 1.0, 2, 18, 6, 4000),
        # (0, 1, 4, None, None, 1.0, 2, 19, 6, 4000),
        # (0, 1, 4, None, None, 1.0, 2, 20, 6, 4000),
        # (0, 1, 5, None, None, 1.0, 2, 21, 6, 4000),
        # (0, 1, 5, None, None, 1.0, 2, 22, 6, 4000),
        # (0, 1, 5, None, None, 1.0, 2, 23, 6, 4000),
        # (0, 1, 5, None, None, 1.0, 2, 24, 6, 4000),
        # (0, 1, 6, None, None, 1.0, 2, 25, 6, 4000),
    ]:
        ...
        try:
            ...
            while run < runs:
                ...
                if int(consensus_tps_raw) <= 1e-9 or ret.get_execution_time() <= 40:
...
def grid5000(ctx, debug=True, console=False, build=True, username="jdecouch", site="luxembourg"):
    for attack_type, arbitragers, faults, lo_size, gamma, workers_per_node, nodes, runs, input_rate in [
        ...
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 1000),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 1500),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 2000),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 2500),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 3000),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 3500),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 4000),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 4500),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 5000),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 5500),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 6000),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 6500),
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 7000),
        # ###### N = 9 ######
        # (1, 3, 0, 100, 1.0, 2, 9, 1, 5000),
        # (2, 3, 0, 100, 1.0, 2, 9, 1, 5000),
        # (3, 3, 0, 100, 1.0, 2, 9, 1, 5000),
        # (10, 3, 0, 100, 1.0, 2, 9, 1, 5000),
        # ###### N = 14 ######
        # (1, 3, 0, 100, 1.0, 2, 14, 1, 5000),
        # (2, 3, 0, 100, 1.0, 2, 14, 1, 5000),
        # (3, 3, 0, 100, 1.0, 2, 14, 1, 5000),
        # (10, 3, 0, 100, 1.0, 2, 14, 1, 5000),
        # ###### CHANGING N ######
        # (0, 1, 1, 100, 1.0, 2, 5, 6, 4000),
        # (0, 1, 1, 100, 1.0, 2, 6, 6, 4000),
        # (0, 1, 1, 100, 1.0, 2, 7, 6, 4000),
        # (0, 1, 1, 100, 1.0, 2, 8, 6, 4000),
        # (0, 1, 2, 100, 1.0, 2, 9, 6, 4000),
        # (0, 1, 2, 100, 1.0, 2, 10, 6, 4000),
        # (0, 1, 2, 100, 1.0, 2, 11, 6, 4000),
        # (0, 1, 2, 100, 1.0, 2, 12, 6, 4000),
        # (0, 1, 3, 100, 1.0, 2, 13, 6, 4000),
        # (0, 1, 3, 100, 1.0, 2, 14, 6, 4000),
        # (0, 1, 3, 100, 1.0, 2, 15, 6, 4000),
        # (0, 1, 3, 100, 1.0, 2, 16, 6, 4000),
        # (0, 1, 4, 100, 1.0, 2, 17, 6, 4000),
        # (0, 1, 4, 100, 1.0, 2, 18, 6, 4000),
        # (0, 1, 4, 100, 1.0, 2, 19, 6, 4000),
        # (0, 1, 4, 100, 1.0, 2, 20, 6, 4000),
        # (0, 1, 5, 100, 1.0, 2, 21, 6, 4000),
        # (0, 1, 5, 100, 1.0, 2, 22, 6, 4000),
        # (0, 1, 5, 100, 1.0, 2, 23, 6, 4000),
        # (0, 1, 5, 100, 1.0, 2, 24, 6, 4000),
        # (0, 1, 6, 100, 1.0, 2, 25, 6, 4000),
    ]:
