...
def das(ctx, debug=True, console=False, build=True, username="mputnik"):
    for attack_type, arbitragers, batch_size, gamma, faults, workers_per_node, nodes, runs, input_rate in [
        ...
        ### Chaning input_rate ###
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 500),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 1000),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 1500),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 2000),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 2500),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 3000),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 3500),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 4000),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 4500),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 5000),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 5500),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 6000),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 6500),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 7000),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 7500),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 8000),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 8500),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 9000),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 9500),
        # (0, 1, 4_000, 1.0, 3, 1, 13, 5, 10_000),
        ### Changing N ###
