...
def das(ctx, debug=True, console=False, build=True, username="mputnik"):
    for attack_type, arbitragers, batch_size, gamma, faults, workers_per_node, nodes, runs, input_rate in [
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 7000),
        # (0, 1, 50, 1.0, 3, 1, 13, 5, 7000),
        # (0, 1, 100, 1.0, 3, 1, 13, 5, 7000),
        # (0, 1, 200, 1.0, 3, 1, 13, 5, 7000),
        # (0, 1, 400, 1.0, 3, 1, 13, 5, 7000),
        # (0, 1, 800, 1.0, 3, 1, 13, 5, 7000),
        ### Changing GAMMA
        # (0, 1, 25 * 128, 1.0, 1, 1, 5,  1, 4000),
        # (0, 1, 25 * 128, 0.9, 1, 1, 6,  5, 4000),
        # (0, 1, 25 * 128, 0.8, 1, 1, 8,  5, 4000),
        # (0, 1, 25 * 128, 0.7, 1, 1, 11, 1, 4000),
        # (0, 1, 25 * 128, 0.6, 1, 1, 21, 5, 4000),
        ### Chaning input_rate ###
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 500),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 1000),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 1500),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 2000),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 2500),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 3000),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 3500),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 4000),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 4500),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 5000),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 5500),
        (0, 1, 25, 1.0, 3, 1, 13, 1, 6000),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 6500),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 7000),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 7500),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 8000),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 8500),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 9000),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 9500),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 10_000),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 10_500),
        # (0, 1, 25, 1.0, 3, 1, 13, 5, 11_000),
        ### Changing N ###
