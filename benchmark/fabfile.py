...
def das(ctx, debug=True, console=False, build=True, username="mputnik"):
    for attack_type, arbitragers, faults, tx_redundancy, lo_size, gamma, workers_per_node, nodes, runs, input_rate in [
        ...
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 3000),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 3500),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 4000),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 4500),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 5000),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 5500),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 6000),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 6500),
        # (0, 1, 1, None, 100, 1.0, 2, 5, 6, 7000),
        # ###### N = 9 ######
        ...
        # ###### N = 14 ######
        # (1, 3, 0, None, 100, 1.0, 2, 14, 1, 5000),
        # (2, 3, 0, None, 100, 1.0, 2, 14, 1, 5000),
        # (3, 3, 0, None, 100, 1.0, 2, 14, 1, 5000),
        # (10, 3, 0, None, 100, 1.0, 2, 14, 1, 5000),
        # ###### CHANGING N ######
        # (0, 1, 1, None, None, 1.0, 2, 5, 6, 4000),
